...
describe('BlockReward', function () {
	...
	describe('returning calcSupply', function () {
		...
		it('when height == 0 should return 7000000000000000', function () {
			expect(blockReward.calcSupply(0)).to.equal(7000000000000000);
		});

		it('when height == 1 should return 7000000000000000', function () {
			expect(blockReward.calcSupply(1)).to.equal(7000000000000000);
		});

		it('when height == (offset - 1) should return 7000000000000000', function () {
			expect(blockReward.calcSupply(1451519)).to.equal(7000000000000000);
		});
